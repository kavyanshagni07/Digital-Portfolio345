<?php
    ...
    function WPTime_preloader_settings_page(){ // settings page function
        ...
        $get_theme_name = $get_theme->get_stylesheet();
        $header_file_url = admin_url("theme-editor.php?file=header.php&theme=$get_theme_name");
                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="description">Open <a target="_blank" href="<?php echo esc_url($header_file_url); ?>">header.php</a> file for your theme, <?php echo $preloader_element; ?></p>
                                </td>
                            </tr>
